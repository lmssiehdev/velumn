...
const MESSAGES = {
    EMBED: {
        ...
        DESCRIPTION: 'Configure how Velumn handles your account privacy and data display.',
        COLOR: 0x0099ff
    },
    BUTTONS: {
    ...
    RESPONSES: {
        ...
        ANONYMIZED: 'Your account has been anonymized. All your public messages will now display a randomized name instead of your username.',
        UNAUTHORIZED: 'You are not authorized to use this command. Please create your own instance.',
        TIMEOUT: 'This interaction has timed out. Please run the command again to continue.',
