import type { AnyThreadChannel, Guild, GuildTextBasedChannel } from "discord.js";
...
const errToLogStringMap = {
  ...
  failed_to_fetch_active_threads: (error: unknown, channel: IndexableChannels) => {
  ...
  log_truncated_out_of_date_threads: (threadsToIndex: number, outOfDateThreads: number) => {
