...
describe("MessageLinkRegex", () => {
	describe("Channel links (without message ID)", () => {
		it("should match standard channel link", () => {
			const link =
				"https://discord.com/channels/1385955477912948806/1424175308872876174";
		...
		it("should match discordapp.com domain", () => {
			const link =
				"https://discordapp.com/channels/1385955477912948806/1424175308872876174";
			const matches = [...link.matchAll(MessageLinkRegex)];
		...
		it("should match without https://", () => {
			const link =
				"discord.com/channels/1385955477912948806/1424175308872876174";
			const matches = [...link.matchAll(MessageLinkRegex)];
	...
	describe("Message links (with message ID)", () => {
		it("should match standard message link", () => {
			const link =
				"https://discord.com/channels/1385955477912948806/1424175308872876174/1424175420123456789";
			const matches = [...link.matchAll(MessageLinkRegex)];
		...
		it("should match DM message link with @me", () => {
			const link =
				"https://discord.com/channels/@me/1424175308872876174/1424175420123456789";
			const matches = [...link.matchAll(MessageLinkRegex)];
		...
		it("should match message link with 17-digit IDs", () => {
			const link =
				"https://discord.com/channels/12345678901234567/12345678901234567/12345678901234567";
			const matches = [...link.matchAll(MessageLinkRegex)];
		...
		it("should match message link with 20-digit IDs", () => {
			const link =
				"https://discord.com/channels/12345678901234567890/12345678901234567890/12345678901234567890";
			const matches = [...link.matchAll(MessageLinkRegex)];
	...
	describe("Multiple matches in text", () => {
		it("should match multiple links in a string", () => {
			const text =
				"Check out https://discord.com/channels/1385955477912948806/1424175308872876174 and https://discord.com/channels/1385955477912948806/1424521073852026890/1424521282946334733";
		...
		it("should work with map like in your code", () => {
			const message = {
				content:
					"Look at https://discord.com/channels/1385955477912948806/1424175308872876174 and https://discord.com/channels/1385955477912948806/1424521073852026890/1424521282946334733",
			};
			const links = [...message.content.matchAll(MessageLinkRegex)].map(
				(m) => ({ ...m.groups }),
			);
		...
		it("should match both channel and message links together", () => {
			const text =
				"Channel: https://discord.com/channels/1385955477912948806/1424175308872876174 Message: https://discord.com/channels/1385955477912948806/1424521073852026890/1424521282946334733";
			const links = [...text.matchAll(MessageLinkRegex)].map((m) => ({
				...m.groups,
			}));
	...
	describe("Invalid links", () => {
		...
		it("should not match with too short IDs (16 digits)", () => {
			const link =
				"https://discord.com/channels/1234567890123456/1234567890123456";
			const matches = [...link.matchAll(MessageLinkRegex)];
		...
		it("should not match with too long IDs (21 digits)", () => {
			const link =
				"https://discord.com/channels/123456789012345678901/123456789012345678901";
			const matches = [...link.matchAll(MessageLinkRegex)];
		...
		it("should not match with non-numeric channel/message IDs", () => {
			const link =
				"https://discord.com/channels/1385955477912948806/notanumber";
			const matches = [...link.matchAll(MessageLinkRegex)];
